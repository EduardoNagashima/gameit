            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (userAlreadyExists)
                        throw { type: 'CONFLICT', message: 'Email já está sendo utilizado.' };
                    return [4 /*yield*/, userRepository.findByUsername(user.username)];
                case 2:
                    usernameExist = _a.sent();
                    if (usernameExist)
                        throw { type: 'CONFLICT', message: 'Username já está sendo utilizado.' };
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!userInfo || !correctPassword)
                        throw { type: 'UNAUTHORIZED', message: 'Senha inválida para este usuário.' };
